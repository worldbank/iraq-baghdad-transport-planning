...
In this analysis, we observe the trends in monthly NO2 levels for Baghdad from 2019 to 2024. The methodology to link economic activity to NO2 is still ongoing. This analysis is one step of it. 
...
**Understanding the unit of Vertical Column Density (VCD)**

VCD, in this case, is measured as molec/m². This value cannot be converted into the usually used Parts Per Million which measures the mixing ratio (typically observed through in-situ measurements). Vertical column density gives the total amount of a gas in a column, while ppm represents a concentration at a specific point. 
...
* **Data Access**: [The Project SharePoint](https://worldbankgroup.sharepoint.com/teams/DevelopmentDataPartnershipCommunity-WBGroup/Shared%20Documents/Forms/AllItems.aspx?csf=1&e=Yvwh8r&FolderCTID=0x012000CFAB9FF0F938A64EBB297E7E16BDFCFD&web=1&id=%2Fteams%2FDevelopmentDataPartnershipCommunity%2DWBGroup%2FShared%20Documents%2FProjects%2FData%20Lab%2FBaghdad%20Transportation%20Planning%2FData%2Fair%5Fpollution%2Fdaily&viewid=80cdadb3%2D8bb3%2D47ae%2D8b18%2Dc1dd89c373c5) currently hosts raw data queried from Google Earth Engine and can be accessed by all project team members.
